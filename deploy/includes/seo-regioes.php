         ...
         <div class="example">
            <nav>
               <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Brasil</a>
                  <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Paraguai</a>
               </div>
            </nav>
            <div class="tab-content" id="nav-tabContent">
               <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                  <div class="row">
                     <div class="col-3">
                        ...
                        <a class="nav-link active" id="v-pills-riograndedosul-tab" data-toggle="pill" href="#regiao-rs" role="tab" aria-controls="v-pills-riograndedosul" aria-selected="true" title="RS - Rio Grande do Sul">Rio Grande do Sul</a>
                        <a class="nav-link " id="v-pills-santacatarina-tab" data-toggle="pill" href="#regiao-sc" role="tab" aria-controls="v-pills-santacatarina" aria-selected="true" title="SC - Santa Catarina">Santa Catarina</a>
                        <a class="nav-link " id="v-pills-parana-tab" data-toggle="pill" href="#regiao-pr" role="tab" aria-controls="v-pills-parana" aria-selected="true" title="PR - Paraná">Paraná</a>
                        <a class="nav-link " id="v-pills-saopaulo-tab" data-toggle="pill" href="#regiao-sp" role="tab" aria-controls="v-pills-saopaulo" aria-selected="true" title="SP - São Paulo">São Paulo</a>
                        <a class="nav-link " id="v-pills-minasgerais-tab" data-toggle="pill" href="#regiao-mg" role="tab" aria-controls="v-pills-minasgerais" aria-selected="true" title="MG - Minas Gerais">Minas Gerais</a>
                        <a class="nav-link " id="v-pills-bahia-tab" data-toggle="pill" href="#regiao-ba" role="tab" aria-controls="v-pills-bahia" aria-selected="true" title="BA - Bahia">Bahia</a>
                        <a class="nav-link " id="v-pills-ceara-tab" data-toggle="pill" href="#regiao-ce" role="tab" aria-controls="v-pills-ceara" aria-selected="true" title="CE - Ceará">Ceará</a>
                        <a class="nav-link " id="v-pills-matogrossodosul-tab" data-toggle="pill" href="#regiao-ms" role="tab" aria-controls="v-pills-matogrossodosul" aria-selected="true" title="MS - Mato Grosso do Sul">Mato Grosso do Sul</a>
                        <a class="nav-link " id="v-pills-sergipe-tab" data-toggle="pill" href="#regiao-se" role="tab" aria-controls="v-pills-sergipe" aria-selected="true" title="SE - Sergipe">Sergipe</a>
                           <a class="nav-link  " id="v-pills-acre-tab" data-toggle="pill" href="#regiao-ac" role="tab" aria-controls="v-pills-acre" aria-selected="true" title="AC - Acre">Acre</a>
                           <a class="nav-link " id="v-pills-alagoas-tab" data-toggle="pill" href="#regiao-al" role="tab" aria-controls="v-pills-alagoas" aria-selected="true" title="AL - Alagoas">Alagoas</a>
                           <a class="nav-link " id="v-pills-amapa-tab" data-toggle="pill" href="#regiao-ap" role="tab" aria-controls="v-pills-amapa" aria-selected="true" title="AP - Amapá">Amapá</a>
                           <a class="nav-link " id="v-pills-amazonas-tab" data-toggle="pill" href="#regiao-am" role="tab" aria-controls="v-pills-amazonas" aria-selected="true" title="AM - Amazonas">Amazonas</a>
                           <a class="nav-link " id="v-pills-espiritosantos-tab" data-toggle="pill" href="#regiao-es" role="tab" aria-controls="v-pills-espiritosantos" aria-selected="true" title="ES - Espírito Santo">Espírito Santos</a>
                           <a class="nav-link " id="v-pills-goias-tab" data-toggle="pill" href="#regiao-go" role="tab" aria-controls="v-pills-goias" aria-selected="true" title="GO - Goiás & DF - Distrito Federal">Goiás / DF</a>
                           <a class="nav-link " id="v-pills-maranhao-tab" data-toggle="pill" href="#regiao-ma" role="tab" aria-controls="v-pills-maranhao" aria-selected="true" title="MA - Maranhão">Maranhão</a>
                           <a class="nav-link " id="v-pills-matogrosso-tab" data-toggle="pill" href="#regiao-mt" role="tab" aria-controls="v-pills-matogrosso" aria-selected="true" title="MT - Mato Grosso">Mato Grosso</a>
                           <a class="nav-link " id="v-pills-para-tab" data-toggle="pill" href="#regiao-pa" role="tab" aria-controls="v-pills-para" aria-selected="true" title="PA - Pará">Pará</a>
                           <a class="nav-link " id="v-pills-paraiba-tab" data-toggle="pill" href="#regiao-pb" role="tab" aria-controls="v-pills-paraiba" aria-selected="true" title="PB - Paraíba">Paraíba</a>
                           <a class="nav-link " id="v-pills-pernambuco-tab" data-toggle="pill" href="#regiao-pe" role="tab" aria-controls="v-pills-pernambuco" aria-selected="true" title="PE - Pernambuco">Pernambuco</a>
                           <a class="nav-link " id="v-pills-piaui-tab" data-toggle="pill" href="#regiao-pi" role="tab" aria-controls="v-pills-piaui" aria-selected="true" title="PI - Piauí">Piauí</a>
                           <a class="nav-link " id="v-pills-riodejaneiro-tab" data-toggle="pill" href="#regiao-rj" role="tab" aria-controls="v-pills-riodejaneiro" aria-selected="true" title="RJ - Rio de Janeiro">Rio de Janeiro</a>
                           <a class="nav-link " id="v-pills-riograndedonorte-tab" data-toggle="pill" href="#regiao-rn" role="tab" aria-controls="v-pills-riograndedonorte" aria-selected="true" title="RN - Rio Grande do Norte">Rio Grande do Norte</a>
                           <a class="nav-link " id="v-pills-rondonia-tab" data-toggle="pill" href="#regiao-ro" role="tab" aria-controls="v-pills-rondonia" aria-selected="true" title="RO - Rondônia">Rondônia</a>
                           <a class="nav-link " id="v-pills-roraima-tab" data-toggle="pill" href="#regiao-rr" role="tab" aria-controls="v-pills-roraima" aria-selected="true" title="RR - Roraima">Roraima</a>
                           <a class="nav-link " id="v-pills-tocantins-tab" data-toggle="pill" href="#regiao-to" role="tab" aria-controls="v-pills-tocantins" aria-selected="true" title="TO - Tocantins">Tocantins</a>
                        </div>
                     </div>
                     <div class="col-9">
                        <div class="tab-content" >
                           <div class="tab-pane fade show " id="regiao-ac" role="tabpanel" aria-labelledby="v-pills-acre-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado do Acre</li>
                                 <li>Rio Branco</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-al" role="tabpanel" aria-labelledby="v-pills-alagoas-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado de Alagoas</li>
                                 <li>Água Branca</li>
                                 <li>Anadia</li>
                                 <li>Arapiraca</li>
                                 <li>Atalaia</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-ap" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado do Amapá</li>
                                 <li>Macapá</li>
                                 <li>Santana</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-am" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado do Amazonas</li>
                                 <li>Manaus</li>
                                 <li>Parintins</li>
                                 <li>Itacoatiara</li>
                                 <li>Manacapuru</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-ba" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-ce" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-es" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-go" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado de Goiás / Distrito Federal</li>
                                 <li>Goiânia</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-ma" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-mt" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-ms" role="tabpanel" aria-labelledby="v-pills-matogrossodosul-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-mg" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-pa" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-pb" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado de Paraíba</li>
                                 <li>João Pessoa</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-pr" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-pe" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-pi" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 ...
                                 <li>São Braz do Piauí</li>
                                 <li>São Félix do Piauí</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-rj" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado do Rio de Janeiro</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-rn" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado do Rio Grande do Norte</li>
                                 <li>Acari</li>
                           ...
                           <div class="tab-pane fade show active " id="regiao-rs" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show " id="regiao-ro" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado do Rondônia</li>
                                 <li>Porto Velho</li>
                                 <li>Ji-Paraná</li>
                                 <li>Ariquemes</li>
                                 <li>Vilhena</li>
                                 ...
                                 <li>Santa Luzia d'Oeste</li>
                                 <li>Cacaulândia</li>
                                 <li>Parecis</li>
                                 <li>Cabixi</li>
                                 <li>São Felipe d'Oeste</li>
                                 <li>Teixeirópolis</li>
                                 <li>Rio Crespo</li>
                                 <li>Castanheiras</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-rr" role="tabpanel" aria-labelledby="v-pills-roraima-tab">
                              <ul class="rubber-list" style="columns: 4;">
                                 <li>Estado de Roraima</li>
                                 <li>Boa Vista</li>
                                 <li>Rorainópolis</li>
                                 <li>Caracaraí</li>
                                 <li>Cantá</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-sc" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 ...
                                 <li>Atalanta</li>
                                 <li>Aurora</li>
                                 <li>Balneario Arroio do Silva</li>
                                 <li>Balneario Barra do Sul</li>
                                 <li>Balneario Camboriu</li>
                                 <li>Balneario Gaivota</li>
                                 <li>Bandeirante</li>
                                 <li>Barra Bonita</li>
                                 <li>Barra Velha</li>
                                 ...
                                 <li>Bombinhas</li>
                                 <li>Botuvera</li>
                                 <li>Braco do Norte</li>
                                 <li>Braco do Trombudo</li>
                                 <li>Brunopolis</li>
                                 <li>Brusque</li>
                                 <li>Cacador</li>
                                 <li>Caibi</li>
                                 ...
                                 <li>Sao Bento do Sul</li>
                                 <li>Sao Bernardino</li>
                                 <li>Sao Bonifacio</li>
                                 <li>Sao Carlos</li>
                                 <li>Sao Cristovao do Sul</li>
                                 <li>Sao Domingos</li>
                                 <li>Sao Francisco do Sul</li>
                                 <li>Sao Joao Batista</li>
                                 <li>Sao Joao do Itaperiu</li>
                                 <li>Sao Joao do Oeste</li>
                                 <li>Sao Joao do Sul</li>
                                 <li>Sao Joaquim</li>
                                 <li>Sao Jose do Cedro</li>
                                 <li>Sao Jose do Cerrito</li>
                                 <li>Sao Jose</li>
                                 <li>Sao Lourenco d'Oeste</li>
                                 <li>Sao Ludgero</li>
                                 <li>Sao Martinho</li>
                                 <li>Sao Miguel d'Oeste</li>
                                 <li>Sao Miguel da Boa Vista</li>
                                 <li>Sao Pedro de Alcantara</li>
                                 <li>Saudades</li>
                                 <li>Schroeder</li>
                                 <li>Seara</li>
                                 <li>Serra Alta</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-sp" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <h2> Regies de São Paulo que Atendemos </h2>
                              <br/>
                              <h4 title = "So Paulo -Região Central">Região Central</h4>
                              <ul class="rubber-list" style="columns: 4;">
                                 <li>Aclimao</li>
                                 <li>Bela Vista</li>
                                 <li>Bom Retiro</li>
                              ...
                              <hr>
                              <h4 title = "So Paulo - Zona Norte">Região Zona Norte</h4>
                              <ul class="rubber-list" style="columns: 4;">
                                 <li>Brasilândia</li>
                                 <li>Cachoeirinha</li>
                                 <li>Casa Verde</li>
                              ...
                              <hr>
                              <h4 title = "So Paulo - Zona Oeste">Região Zona Oeste</h4>
                              <ul class="rubber-list" style="columns: 4;">
                                 <li>Bairro do Limo</li>
                                 <li>Barra Funda</li>
                                 <li>Alto da Lapa</li>
                              ...
                              <hr>
                              <h4 title = "So Paulo - Zona Sul">Região Zona Sul</h4>
                              <ul class="rubber-list" style="columns: 4;">
                                 <li>Aeroporto</li>
                                 <li>ÁguaFunda</li>
                                 <li>Brooklin</li>
                                 ...
                                 <li>JardimAmrica</li>
                                 <li>JardimEuropa</li>
                                 <li>JardimPaulista</li>
                                 <li>JardimPaulistano</li>
                                 <li>JardimSoLuiz</li>
                                 <li>Jardins</li>
                                 <li>Jockey Club</li>
                                 <li>M'Boi Mirim</li>
                              ...
                              <hr>
                              <h4 title = "So Paulo - Zona Leste">Região Zona Leste</h4>
                              <ul class="rubber-list" style="columns: 4;">
                                 <li>Água Rasa</li>
                                 <li>Anlia Franco</li>
                                 <li>Aricanduva</li>
                                 ...
                                 <li>Parque So Lucas</li>
                                 <li>Parque So Rafael</li>
                                 <li>Penha</li>
                                 <li>Ponte Rasa</li>
                                 <li>So Mateus</li>
                                 <li>So Miguel Paulista</li>
                                 <li>Sapopemba</li>
                                 <li>Tatuap</li>
                                 <li>Vila Carro</li>
                                 <li>Vila Curu</li>
                              ...
                              <hr>
                              <h4 title = "So Paulo - Grande São Paulo">Grande São Paulo</h4>
                              <ul class="rubber-list" style="columns: 4;">
                                 <li>So Caetano do Sul</li>
                                 <li>So Bernardo do Campo</li>
                                 <li>Santo Andr</li>
                                 <li>Diadema</li>
                                 <li>Guarulhos</li>
                                 <li>Suzano</li>
                                 ...
                                 <li>Cotia</li>
                                 <li>Itapevi</li>
                                 <li>Santana de Parnaba</li>
                                 <li>Caierias</li>
                                 <li>Franco da Rocha</li>
                                 <li>Taboo da Serra</li>
                                 <li>Cajamar</li>
                                 <li>Aruj</li>
                                 <li>Alphaville</li>
                                 <li>Mairipor</li>
                              ...
                              <hr>
                              <h4 title = "So Paulo - Litoral de São Paulo">Litoral de SãoPaulo</h4>
                              <ul class="rubber-list" style="columns: 4;">
                                 <li>Bertioga</li>
                                 <li>Canania</li>
                                 <li>Caraguatatuba</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-se" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado de Sergipe</li>
                           ...
                           <div class="tab-pane fade show " id="regiao-to" role="tabpanel" aria-labelledby="v-pills-amapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Estado do Tocantins</li>
                                 <li>Palmas</li>
                                 <li>Araguaína</li>
                                 <li>Gurupi</li>
               ...
               <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                  <div class="row">
                     <div class="col-3">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                           <a class="nav-link active " id="" data-toggle="pill" href="#altoparaguay" role="tab" aria-controls="v-pills-altoparaguay" aria-selected="true">Alto Paraguay </a>
                           <a class="nav-link " id="v-pills-altoparana-tab" data-toggle="pill" href="#altoparana" role="tab" aria-controls="v-pills-altoparana" aria-selected="true">Alto Paraná </a>
                           <a class="nav-link " id="v-pills-amambay-tab" data-toggle="pill" href="#amambay" role="tab" aria-controls="v-pills-amambay" aria-selected="true">Amambay </a>
                           
                           <a class="nav-link " id="v-pills-boqueron-tab" data-toggle="pill" href="#boqueron" role="tab" aria-controls="v-pills-boqueron" aria-selected="true">Boquerón </a>
                           <a class="nav-link " id="v-pills-capital-tab" data-toggle="pill" href="#capital" role="tab" aria-controls="v-pills-capital" aria-selected="true">Distrito Capital </a>
                           <a class="nav-link " id="v-pills-caaguazu-tab" data-toggle="pill" href="#caaguazu" role="tab" aria-controls="v-pills-caaguazu" aria-selected="true">Caaguazú </a>
                           <a class="nav-link " id="v-pills-caazapa-tab" data-toggle="pill" href="#caazapa" role="tab" aria-controls="v-pills-caazapa" aria-selected="true">Caazapá </a>
                           <a class="nav-link " id="v-pills-canindeyu-tab" data-toggle="pill" href="#canindeyu" role="tab" aria-controls="v-pills-canindeyu" aria-selected="true">Canindeyú </a>
                           <a class="nav-link " id="v-pills-central-tab" data-toggle="pill" href="#central" role="tab" aria-controls="v-pills-central" aria-selected="true">Central </a>
                           <a class="nav-link " id="v-pills-concepcion-tab" data-toggle="pill" href="#concepcion" role="tab" aria-controls="v-pills-concepcion" aria-selected="true">Concepción </a>
                           <a class="nav-link " id="v-pills-cordillera-tab" data-toggle="pill" href="#cordillera" role="tab" aria-controls="v-pills-cordillera" aria-selected="true">Cordillera </a>
                           <a class="nav-link " id="v-pills-guaira-tab" data-toggle="pill" href="#guaira" role="tab" aria-controls="v-pills-guaira" aria-selected="true">Guairá </a>
                           <a class="nav-link " id="v-pills-itapua-tab" data-toggle="pill" href="#itapua" role="tab" aria-controls="v-pills-itapua" aria-selected="true">Itapúa </a>
                           <a class="nav-link " id="v-pills-misiones-tab" data-toggle="pill" href="#misiones" role="tab" aria-controls="v-pills-misiones" aria-selected="true">Misiones </a>
                           <a class="nav-link " id="v-pills-neembucu-tab" data-toggle="pill" href="#neembucu" role="tab" aria-controls="v-pills-neembucu" aria-selected="true">Ñeembucú </a>
                           <a class="nav-link " id="v-pills-paraguari-tab" data-toggle="pill" href="#paraguari" role="tab" aria-controls="v-pills-paraguari" aria-selected="true">Paraguarí </a>
                           <a class="nav-link " id="v-pills-presidentehayes-tab" data-toggle="pill" href="#presidentehayes" role="tab" aria-controls="v-pills-presidentehayes" aria-selected="true">Presidente Hayes </a>
                           <a class="nav-link " id="v-pills-sanpedro-tab" data-toggle="pill" href="#sanpedro" role="tab" aria-controls="v-pills-sanpedro" aria-selected="true">San Pedro </a>
                        </div>
                     </div>
                     <div class="col-9">
                        <div class="tab-content" id="v-pills-tabContent">
                           <div class="tab-pane fade show active" id="altoparaguay" role="tabpanel" aria-labelledby="v-pills-altoparaguay-tab">
                              <ul class="rubber-list" style="columns: 3;">
                              <li>Fuerte Olimpo</li>
                              </ul>
                           </div>
                           <div class="tab-pane fade show" id="altoparana" role="tabpanel" aria-labelledby="v-pills-altoparana-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 ...
                                 <li>Itakyry</li>
                                 <li>Santa Rita</li>
                                 <li>Juan Emilio O'Leary</li>
                                 <li>Doctor Juan León Mallorquín</li>
                              </ul>
                           </div>
                           <div class="tab-pane fade show" id="amambay" role="tabpanel" aria-labelledby="v-pills-amambay-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Pedro Juan Caballero</li> 	
                                 <li>Capitán Bado</li> 
                                 <li>Bella Vista Norte</li>
                              </ul>
                           </div>

                           <div class="tab-pane fade show" id="boqueron" role="tabpanel" aria-labelledby="v-pills-boqueron-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Mariscal José Félix Estigarribia</li>
                                 <li>Filadelfia</li>
                              </ul>
                           </div>

                           <div class="tab-pane fade show" id="capital" role="tabpanel" aria-labelledby="v-pills-capital-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Assunção</li>
                              </ul>
                           </div>

                           <div class="tab-pane fade show" id="caaguazu" role="tabpanel" aria-labelledby="v-pills-caaguazu-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Coronel Oviedo</li>
                                 <li>Doctor Juan Eulogio Estigarribia</li>
                                 <li>Yhú</li>
                                 <li>Repatriación</li>
                                 <li>Doctor Juan Manuel Frutos</li>
                                 <li>San José de los Arroyos</li>
                                 <li>San Joaquín</li>
                                 <li>Raúl Arsenio Oviedo</li>
                              </ul>
                           </div>

                           <div class="tab-pane fade show" id="canindeyu" role="tabpanel" aria-labelledby="v-pills-canindeyu-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Curuguaty</li>
                                 <li>Salto del Guairá</li>
                                 <li>Yasy Cañy</li>
                                 <li>Villa Ygatimí</li>
                              </ul>
                           </div>

                           <div class="tab-pane fade show" id="caazapa" role="tabpanel" aria-labelledby="v-pills-caazapa-tab">
                              <ul class="rubber-list" style="columns: 3;">
                           ...
                           <div class="tab-pane fade show" id="central" role="tabpanel" aria-labelledby="v-pills-central-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Luque</li>
                                 <li>San Lorenzo</li>
                                 <li>Capiatá</li>
                           ...
                           <div class="tab-pane fade show" id="concepcion" role="tabpanel" aria-labelledby="v-pills-concepcion-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Concepción</li>
                                 <li>Horqueta</li>
                                 <li>Yby Yaú</li>
                           ...
                           <div class="tab-pane fade show" id="cordillera" role="tabpanel" aria-labelledby="v-pills-cordillera-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Caacupé</li>	
                                 <li>Tobatí</li>
                                 <li>Piribebuy</li>
                                 <li>Arroyos y Esteros</li>
                                 <li>Eusebio Ayala</li>
                                 <li>Emboscada</li>
                                 <li>Atyrá</li>
                              </ul>
                           ...
                           <div class="tab-pane fade show" id="guaira" role="tabpanel" aria-labelledby="v-pills-guaira-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Villarrica</li>
                                 <li>Independencia</li>
                                 <li>Paso Yobái</li>
                           ...
                           <div class="tab-pane fade show" id="itapua" role="tabpanel" aria-labelledby="v-pills-itapua-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Encarnación</li>
                                 <li>Cambyretá</li>
                                 <li>San Pedro del Paraná</li>
                                 <li>Tomás Romero Pereira</li>
                                 <li>Edelira</li>
                                 <li>San Rafael del Paraná</li>
                                 <li>Natalio</li>
                                 <li>Coronel José Félix Bogado</li>
                                 <li>Carlos Antonio López</li>
                                 <li>Alto Verá</li>
                                 <li>Obligado</li>
                                 <li>Itapúa Poty</li>
                              </ul>
                           ...
                           <div class="tab-pane fade show" id="misiones" role="tabpanel" aria-labelledby="v-pills-misiones-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>San Ignacio Guazú</li>
                           ...
                           <div class="tab-pane fade show" id="presidentehayes" role="tabpanel" aria-labelledby="v-pills-presidentehayes-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Villa Hayes</li>
                                 <li>Teniente Primero Manuel Irala Fernández</li>
                                 <li>Benjamín Aceval</li>
                              </ul>
                           </div>

                           <div class="tab-pane fade show" id="neembucu" role="tabpanel" aria-labelledby="v-pills-neembucu-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Pilar</li>
                              </ul>
                           </div>

                           <div class="tab-pane fade show" id="paraguari" role="tabpanel" aria-labelledby="v-pills-paraguari-tab">
                              <ul class="rubber-list" style="columns: 3;">
                                 <li>Carapeguá</li>
                                 <li>Carapeguá</li>
                                 <li>Yaguarón</li>
                           ...
                           <div class="tab-pane fade show" id="sanpedro" role="tabpanel" aria-labelledby="v-pills-sanpedro-tab">
                              <ul class="rubber-list" style="columns: 3;">
                              <li>San Estanislao</li>
                              <li>Capiibary</li>
                              <li>Santa Rosa del Aguaray</li>
                              <li>San Pedro de Ycuamandiyú</li>
                              <li>Guayaibí</li>
                              <li>Choré</li>
                              <li>General Isidoro Resquín</li>
                              <li>Liberación</li>
                              <li>General Elizardo Aquino</li>
                              </ul>
                           </div>
