...
foreach ( $tabs as $tab ) {
    ...
    if($tab_title) {
        ...
        if ($show_icon && $icon) {
            if ($type == 'tabs-simple') {
                if ($icon_color || $icon_bg_color || $icon_border_color || $icon_wrap_border_color || $icon_shadow_color || $icon_hcolor || $icon_hbg_color || $icon_hborder_color || $icon_wrap_hborder_color || $icon_hshadow_color) :
                    ?>
