 ...
 */
	var $defaultOptions = array(
		...
		'imageMagickPath' => '/usr/sbin/convert', // Path to imageMagick on your server
		'fields' => array(
			'dir' => 'dir',
			'filesize' => 'filesize',
			'mimetype' => 'mimetype'
 ...
 */
	function __construct() {
		$messages = array(
			...
			'Empty' => array(
				'message' => __d('meio_upload', 'Você deve escolher um arquivo.', true)
			),
			'UploadError' => array(
				'message' => __d('meio_upload', 'Houve alguma problema ao efeturar o upload, por favor tente novamente.', true)
			),
			'MaxSize' => array(
				'message' => __d('meio_upload', 'O arquivo ultrapassou o tamanho permitido.', true)
			),
			'InvalidMime' => array(
				'message' => __d('meio_upload', 'Tipo do arquivo inválido.', true)
			),
			'InvalidExt' => array(
				'message' => __d('meio_upload', 'Extensão inválida.', true)
			),
			'MinWidth' => array(
